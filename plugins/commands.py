...
** I am Lawless Fonts Bot ✍️**

`I can help you to get stylish fonts. Just send me some text and see magic.`

** Developed by :** ❤️ ▷ [@Lawless_Fellas_Hub](https://t.me/Lawless_Fellas_Hub)
"""

    # Buttons
    buttons = [
        [
            InlineKeyboardButton('👥 Group', url=f"https://t.me/Lawless_Fellas_Hub"),
            InlineKeyboardButton('Channel 📢', url=f"https://t.me/Lawless_Updates")
            ],[
            InlineKeyboardButton('❤️ Credit', url=f"https://t.me/{owner_username}"),
            InlineKeyboardButton('GitHup 🤣', url=f"https://github.com/ShikariBaaZ")
            ],
    ]
    await m.reply_text(
        text=text,
